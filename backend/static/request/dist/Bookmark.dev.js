...
$(document).ready(function () {
  $('.BM-btn').click(function (event) {
    ...
    $("#".concat(value)).toggleClass("active");
    setTimeout(function () {
    ...
    $.ajax({
      ...
      success: function success(data) {
        console.log(data);
        $("#".concat(value)).text(data.add); //reset form
      }
    }).done(function (data) {
      console.log(data);
      return "done";
  ...
  $('.qty-btn-submit').click(function (event) {
    ...
    $.ajax({
      ...
      success: function success(data2) {
        ...
        $('.qty-btn-submit').css('background-color', 'grey'); //reset form
      }
    });
  }); // var x = f();
  ...
  $('.quantity-right-plus').click(function (e) {
    ...
    var total_price = parseInt(document.getElementById("unit-price-js").innerHTML); // If is not undefined
